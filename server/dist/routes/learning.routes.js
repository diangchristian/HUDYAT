...
import { getLearningAreas, getCategoryLesson, saveLessonCheckpoint, } from "../controllers/learning.controller.js";
...
learningRouter.patch("/categories/:categoryId/checkpoint", saveLessonCheckpoint);
