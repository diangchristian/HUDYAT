...
export type GetQuestionChoiceAggregateType<T extends QuestionChoiceAggregateArgs> = {
    [P in keyof T & keyof AggregateQuestionChoice]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateQuestionChoice[P]> : Prisma.GetScalarType<T[P], AggregateQuestionChoice[P]>;
};
...
export type GetQuestionChoiceGroupByPayload<T extends QuestionChoiceGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<QuestionChoiceGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof QuestionChoiceGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], QuestionChoiceGroupByOutputType[P]> : Prisma.GetScalarType<T[P], QuestionChoiceGroupByOutputType[P]>;
}>>;
...
export type QuestionChoiceCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<QuestionChoiceFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface QuestionChoiceDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * })
    **/
    count<T extends QuestionChoiceCountArgs>(args?: Prisma.Subset<T, QuestionChoiceCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], QuestionChoiceCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends QuestionChoiceGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, QuestionChoiceGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetQuestionChoiceGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
